...
public class MainActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        funds.setOnClickListener(v -> startActivity(new Intent(MainActivity.this, com.betplay.dpboss_off.deposit_money.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK)));
